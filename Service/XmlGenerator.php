        ...
        foreach ($dataCollection as $name => $content) {
            ...
            foreach ($content as $googleProductModel) {
                try {
                    ...
                    foreach ($googleProductModel->getExtraFields() as $extraField){
                        $xml .= $this->generateXmlNode($extraField['google_field'], $extraField['value'], $googleProductModel->getSuffix(), false);
                    }
