...
class GenerateXmlFileCommand extends ContainerAwareCommand
{
    public function __construct(
        protected ProductProvider $productProviderService,
        protected  XmlGenerator $xmlGenerator,
        protected GoogleshoppingxmlLogQuery $logger
    )
    {
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (true === $input->getArgument('optimised-mode')) {
            try {
                ...
                $this->xmlGenerator->export($this->productProviderService->getContent($feed), $filePath, $output);
     ...
     */
    private function executeLegacyGeneration(Filesystem $fs, $feeds): void
    {
